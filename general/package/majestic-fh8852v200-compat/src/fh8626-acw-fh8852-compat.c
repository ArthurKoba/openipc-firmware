...
static const uint8_t fh8626_retail_init_params[0x17a] = {
...
static int apply_retail_init_params(void)
{
    struct ac_init_params_command r = {
        ...
        .size_b = 0x18a,
        .opcode = 0x01040022u,
        .blob_length = sizeof(fh8626_retail_init_params),
    };
    int rc;

    memcpy(r.blob, fh8626_retail_init_params,
           sizeof(fh8626_retail_init_params));
    rc = command(&r);
    return rc ? rc : r.status;
}
